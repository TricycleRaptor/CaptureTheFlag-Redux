...
local V = {
	...
	Class = "tfa_ins2_acrc",
	Category = "Rifleman Primary Weapon",
...
local V = {
	...
	Category = "Marksman Primary Weapon",
...
local V = {
	...
	Category = "Gunner Primary Weapon",
...
local V = {
	...
	Category = "Support Primary Weapon",
...
local V = {
	...
	Class = "tfa_ins2_nova",
	Category = "Engineer Primary Weapon",

...
list.Set( "simfphys_ctf_recon", "sim_fphys_v8elite_armed", V )
...
list.Set( "simfphys_ctf_recon", "sim_fphys_v8elite_armed2", V )
...
list.Set( "simfphys_ctf_recon", "sim_fphys_conscriptapc_armed", V )
...
list.Set( "simfphys_ctf_recon", "sim_fphys_combineapc_armed", V )
...
list.Set( "simfphys_ctf_tanks", "sim_fphys_tank2", V )
...
list.Set( "simfphys_ctf_tanks", "sim_fphys_tank", V )
...
list.Set( "simfphys_ctf_tanks", "sim_fphys_tank3", V )
...
list.Set( "simfphys_ctf_tanks", "sim_fphys_tank4", V )
